...
import { getOneCompany, updatecompany } from '../../../../services/companies'
import styles from './edit_company.module.css'
    ...
    <div>
            ...
            <form className={`${styles.add_form} px-4 py-4`} onSubmit={submitForm}>
                ...
                <div className='row justify-content-between mb-4 mt-4'>
                    ...
                    <div className='col-12 col-md-4 text-center mb-2'>
                        <img className={styles.img_style} src={formVals.img_url} alt="image" />
                    </div>
                </div>
